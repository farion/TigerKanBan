...
CREATE TABLE tk_task (id BIGINT AUTO_INCREMENT, title VARCHAR(255), link VARCHAR(255), area_id BIGINT, sf_guard_user_id INT, effort FLOAT(18, 2), INDEX area_id_idx (area_id), INDEX sf_guard_user_id_idx (sf_guard_user_id), PRIMARY KEY(id)) ENGINE = INNODB;
