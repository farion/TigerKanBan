...
abstract class BasetkTaskForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'readyDate'        => new sfWidgetFormInputText(),
    ...
    $this->setValidators(array(
      ...
      'lane_id'          => new sfValidatorDoctrineChoice(array('model' => $this->getRelatedModelName('lane'), 'required' => false)),
      ...
      'readyDate'        => new sfValidatorPass(array('required' => false)),
