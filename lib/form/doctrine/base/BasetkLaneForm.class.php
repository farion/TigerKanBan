...
/**
 * tkLane form base class.
 *
 * @method tkLane getObject() Returns the current form's model object
 *
 * @package    tigerkanban
 * @subpackage form
 ...
 */
abstract class BasetkLaneForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('tk_lane[%s]');
